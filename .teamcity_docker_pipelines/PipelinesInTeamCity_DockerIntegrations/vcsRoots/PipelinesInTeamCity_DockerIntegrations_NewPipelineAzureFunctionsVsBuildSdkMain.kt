...
object PipelinesInTeamCity_DockerIntegrations_NewPipelineAzureFunctionsVsBuildSdkMain : GitVcsRoot({
    id("NewPipelineAzureFunctionsVsBuildSdkMain")
    name = "New pipeline: Azure Functions VS Build SDK: main"
