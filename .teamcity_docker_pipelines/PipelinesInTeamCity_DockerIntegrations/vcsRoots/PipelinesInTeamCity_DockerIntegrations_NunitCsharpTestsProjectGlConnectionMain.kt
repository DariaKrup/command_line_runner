...
object PipelinesInTeamCity_DockerIntegrations_NunitCsharpTestsProjectGlConnectionMain : GitVcsRoot({
    id("NunitCsharpTestsProjectGlConnectionMain")
    name = "Nunit Csharp Tests Project: GL connection: main"
